    ...
    inputSchema: {
      ...
      properties: {
          ...
          items: {
            ...
            properties: {
              ...
              url: {
                type: "string",
                description:
                  'Relative URL (e.g., "accounts(guid)" or "contacts")',
              },
              body: {
                type: "object",
        ...
        useChangeset: {
          type: "boolean",
          description:
            "Wrap mutating operations (POST/PATCH/DELETE) in an atomic changeset. A failure rolls back ALL operations in the changeset. Defaults to false.",
        },
      },
      required: ["requests"],
    },
