...
**Why it matters:** Full MCP spec coverage (tools + resources + prompts) — a first for any Dataverse MCP server. Schema tools complete the entity lifecycle: create table → add columns → define relationships.
