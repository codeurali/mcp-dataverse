...
import {
  metadataTools,
  handleMetadataTool,
} from "../../src/tools/metadata.tools.js";
...
import {
  relationTools,
  handleRelationTool,
} from "../../src/tools/relations.tools.js";
import {
  actionTools,
  handleActionTool,
  ...
  server.setRequestHandler(CallToolRequestSchema, async (request) => {
    ...
    try {
      ...
      if (metadataNames.has(name))
        return handleMetadataTool(name, args, dvClient);
      ...
      if (relationNames.has(name))
        return handleRelationTool(name, args, dvClient);
