...
export const metadataReadTools = [
    {
...
// ── Handler ────────────────────────────────────────────────────────────────────
export async function handleMetadataReadTool(name, args, client) {
    switch (name) {
        ...
        default:
            throw new Error(`Unknown metadata-read tool: ${name}`);
    }
}
//# sourceMappingURL=metadata-read.tools.js.map